...
@section('content')
            ...
            <div class="feature-3-area-inner section-spacing">
              <div class="feature-3-thumb-wrapper fade-anim" data-direction="left">
                <div class="feature-3-thumb-1 img-reveal-anim">
                  <img src="{{ asset('FrontendAssets/imgs/gallery/gallery-27.webp')}}" alt="image">
                </div>
                <div class="feature-3-thumb-2" data-speed="0.9">
                  <img src="{{ asset('FrontendAssets/imgs/gallery/gallery-28.webp')}}" alt="image">
                </div>
              </div>
                ...
                <div class="feature-list">
                  ...
                  <div class="cta-box">
                    <div class="icon rr-bg-white">
                      <img src="{{ asset('FrontendAssets/imgs/icon/icon-25.webp')}}" alt="image">
                    </div>
                    <div class="cta-text">
        ...
        <div class="cta-area fade-anim">
          <div class="cta-area-bg">
            <img src="{{ asset('FrontendAssets/imgs/gallery/gallery-16.webp')}}" alt="image">
          </div>
          <div class="container rr-container-1410">
            <div class="cta-area-inner">
              <div class="cta-info-box">
                ...
                <div class="client-group">
                  <img src="{{ asset('FrontendAssets/imgs/client/client-7.webp')}}" alt="image">
                  <img src="{{ asset('FrontendAssets/imgs/client/client-8.webp')}}" alt="image">
                  <img src="{{ asset('FrontendAssets/imgs/client/client-9.webp')}}" alt="image">
                  <img src="{{ asset('FrontendAssets/imgs/client/client-10.webp')}}" alt="image">
                  <img src="{{ asset('FrontendAssets/imgs/client/client-11.webp')}}" alt="image">
                  <img src="{{ asset('FrontendAssets/imgs/client/client-12.webp')}}" alt="image">
                </div>
            ...
            <div class="story-2-area-inner section-spacing">
              ...
              <div class="story-2-thumb-wrapper-box fade-anim">
                <div class="story-2-bg">
                  <img src="{{ asset('FrontendAssets/imgs/shape/shape-22.webp')}}" alt="image">
                </div>
                <div class="story-2-thumb-wrapper">
                  <div class="story-2-thumb">
                    ...
                    <img src="{{ asset('FrontendAssets/imgs/gallery/gallery-30.webp')}}" alt="image">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="counter-2-area fade-anim">
          ...
          <div class="container rr-container-1410">
            <div class="counter-2-area-inner">
              <div class="counter-2-wrapper-box">
                <div class="counter-2-wrapper">
                  <div class="counter-2-box fade-anim">
                    <div class="icon">
                      <img src="{{ asset('FrontendAssets/imgs/icon/icon-27.webp')}}" alt="image">
                    </div>
                    <div class="content">
                  ...
                  <div class="counter-2-box fade-anim">
                    <div class="icon">
                      <img src="{{ asset('FrontendAssets/imgs/icon/icon-28.webp')}}" alt="image">
                    </div>
                    <div class="content">
                  ...
                  <div class="counter-2-box fade-anim">
                    <div class="icon">
                      <img src="{{ asset('FrontendAssets/imgs/icon/icon-29.webp')}}" alt="image">
                    </div>
                    <div class="content">
                  ...
                  <div class="counter-2-box fade-anim">
                    <div class="icon">
                      <img src="{{ asset('FrontendAssets/imgs/icon/icon-30.webp')}}" alt="image">
                    </div>
                    <div class="content">
        ...
        <section class="feature-1-area">
          <div class="container rr-container-1410">
            <div class="feature-1-area-inner section-spacing">
              ...
              <div class="feature-1-wrapper-box">
                <div class="feature-1-wrapper">
                  <div class="feature-1-box fade-anim">
                    <div class="icon">
                      <img src="{{ asset('FrontendAssets/imgs/icon/icon-15.webp')}}" alt="image">
                    </div>
                    <div class="content">
                  ...
                  <div class="feature-1-box fade-anim">
                    <div class="icon">
                      <img src="{{ asset('FrontendAssets/imgs/icon/icon-16.webp')}}" alt="image">
                    </div>
                    <div class="content">
                  ...
                  <div class="feature-1-box fade-anim">
                    <div class="icon">
                      <img src="{{ asset('FrontendAssets/imgs/icon/icon-17.webp')}}" alt="image">
                    </div>
                    <div class="content">
        ...
        <div class="brand-3-area fade-anim">
          <div class="brand-3-bg">
            <img src="{{ asset('FrontendAssets/imgs/gallery/gallery-31.webp')}}" alt="image">
          </div>
          <div class="container rr-container-1410">
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <div class="brand-3-box">
                          <img src="{{ asset('FrontendAssets/imgs/brand/brand-9.webp')}}" alt="image">
                        </div>
                      </div>
                      <div class="swiper-slide">
                        <div class="brand-3-box">
                          <img src="{{ asset('FrontendAssets/imgs/brand/brand-10.webp')}}" alt="image">
                        </div>
                      </div>
                      <div class="swiper-slide">
                        <div class="brand-3-box">
                          <img src="{{ asset('FrontendAssets/imgs/brand/brand-11.webp')}}" alt="image">
                        </div>
                      </div>
                      <div class="swiper-slide">
                        <div class="brand-3-box">
                          <img src="{{ asset('FrontendAssets/imgs/brand/brand-12.webp')}}" alt="image">
                        </div>
                      </div>
                      <div class="swiper-slide">
                        <div class="brand-3-box">
                          <img src="{{ asset('FrontendAssets/imgs/brand/brand-13.webp')}}" alt="image">
                        </div>
                      </div>
                      <div class="swiper-slide">
                        <div class="brand-3-box">
