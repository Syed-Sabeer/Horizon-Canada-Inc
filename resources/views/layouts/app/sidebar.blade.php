        ...
        <div class="sidebar-wrapper" data-sidebar-layout="stroke-svg">
          <div>
            ...
            <nav class="sidebar-main">
             ...
             <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title link-nav" href="{{route('admin.dashboard')}}">
                  ...
                  <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i>
                    ...
                    <ul class="sidebar-submenu">
                      ...
                      <li><a class="lan-4" href="{{route('admin.privacy-policy.index')}}">Privacy Policy</a></li>
                    <!--  <li><a class="lan-5" href="{{route('admin.newsletter.index')}}">Newsletter</a></li> -->
                      ...
                      <li><a class="lan-5" href="{{route('admin.mini-service.index')}}">Mini Services</a></li>
                   ...
                   <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i>
                    ...
                    <ul class="sidebar-submenu">
                      <li><a class="lan-4" href="{{route('admin.home.index')}}">Home Page</a></li>
                      ...
                      <li><a class="lan-4" href="{{route('admin.service-page.index')}}">Service Page</a></li>
                      <li><a class="lan-4" href="{{route('admin.ourcompany.cms')}}">Our Company Page</a></li>
                      <li><a class="lan-4" href="{{route('admin.company.welcome')}}">Company Welcome Page</a></li>
             ...
             <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title link-nav" href="{{route('admin.company.settings')}}">
                      <svg class="stroke-icon">
